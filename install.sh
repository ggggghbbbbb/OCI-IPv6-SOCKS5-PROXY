...
read -rp "代理用户名 [proxy]: " PROXY_USER; PROXY_USER=${PROXY_USER:-proxy}
read -rsp "代理密码 [随机生成]: " PROXY_PASS; echo; PROXY_PASS=${PROXY_PASS:-$(openssl rand -hex 8 2>/dev/null || date +%s)}
